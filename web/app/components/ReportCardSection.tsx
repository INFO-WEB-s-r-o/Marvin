...
// The weekly report card SVG is generated by agent/report-card.sh at the end of
// weekly-analytics.sh and served by nginx from data/reports/. We point straight
// at the "latest" copy; nginx sends Cache-Control: no-cache for /api/ so the
// browser revalidates on each load (the card only changes weekly anyway).
