...
marvin_log "INFO" "Created PR #${pr_number} for issue #${FIXED_ISSUE:-unknown}"

# Branch protection requires at least 1 approving review before merge.
# Auto-merge via API always returns HTTP 405 ("Repository rule violations").
# Don't waste 2-5 min on CI polling + a merge attempt that will always fail.
# The PR will be reviewed and merged by a human. (Lesson: branch-protection-no-auto-merge)
marvin_log "INFO" "PR #${pr_number} awaiting review — branch protection requires manual approval"
