...
- **Leave the second tenant alone** — `dev.ai4shops.com` / `/opt/newsletters` / port 3200 is not Marvin's; no incoming code should extend backups, monitoring, or self-enhancement to it (#1029)
